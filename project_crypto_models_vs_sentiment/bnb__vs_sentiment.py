...
url = "/home/yass/code/yass2803/cryptoteller/data/BNBUSDT.csv"
df = pd.read_csv(url)
df.head()
...
df_sentiment = pd.read_csv("/home/yass/code/yass2803/cryptoteller/data/sentiment/aggr_sent_bnb.csv")
